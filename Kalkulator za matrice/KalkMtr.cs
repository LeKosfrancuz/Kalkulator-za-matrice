...
class Program
{
    static void Main()
    {
        ...
        string zbrajanje = "ADD".ToUpper();
        string mnozenje = "MTY".ToUpper();
        string ispisMatrice = "PRINT".ToUpper();
        string definiranjeMatrice = "DEF".ToUpper();
        string spremiUVarijablu = "ST".ToUpper();
        string exitProgram = "ESC".ToUpper();
        string helpMenu = "HELP".ToUpper();
        string transpozicija = "T".ToUpper();
...
///                         KOMANDNA LINIJA
        ...
        while(!exit)
        {
            ...
            if (userCommandFunc == "Q" || userCommandFunc == exitProgram) { exit = true; continue; }


            if (userCommandSplit.Length == 1 && userCommandFunc != "Q" && userCommandFunc != exitProgram) { Console.WriteLine("Potrebni su operandi (nakon ključne riječi)"); continue; }
            ...
            if (userCommandFunc == zbrajanje)
            {
                ...
                if (userCommandArgs.Length < 4)
                {
                    ...
                    } catch (InvalidOperationException e) {Console.WriteLine("{0}", e.Message); continue;}
                } 
        ...
        Console.WriteLine("Kalkulator matrica v1.2, Lipanj 2022.");
        Thread.Sleep(500);
